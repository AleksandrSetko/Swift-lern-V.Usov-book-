...
if x1 > 0 && y1 > 0 {
    print("Точка координат находится в первой четверти координатной плоскости")
} else if x1 < 0 && y1 > 0 {
    print("Точка координат находится во второй четверти координатной плоскости")
} else if x1 < 0 && y1 < 0 {
    print("Точка координат находится в третьей четверти координатной плоскости")
} else if x1 < 0 && y1 < 0 {
    print("Точка координат находится в четвертой четверти координатной плоскости")
} else {
